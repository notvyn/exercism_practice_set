...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    reactor_value = temperature * neutrons_emitted
    if temperature < 800 and neutrons_emitted > 500 and reactor_value < 500000:
        return True
    else:
        return False
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    threshold_percent_10 = threshold * 0.1
    
    if reactor_value < threshold * 0.9:
        return 'LOW'

    # translation: reactor_value > threshold - threshold_percent_10 and reactor_value < threshold + threshold_percent_10
    if threshold - threshold_percent_10 < reactor_value < threshold + threshold_percent_10:
        return 'NORMAL'
