...
def approx_average_is_average(hand):
    ...
    approx_average_by_index = (hand[0]+hand[-1]) / 2
    approx_average_by_median = hand[int(len(hand)/2)]
    is_average = card_average(hand) == approx_average_by_index or card_average(hand) == approx_average_by_median
